    ...
    return ( 
        ...
        <div className="absolute centerScreen shadow-2xl bg-white rounded-lg">
                    ...
                    <div className="mt-8 mx-10">
                        <label for="dropzone-file" className="flex flex-col items-center justify-center  w-[350px] h-[230px] border-[1px]   border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-lightGray hover:bg-gray-100 dark:border-lightBlue dark:hover:border-gray-500 dark:hover:bg-gray-600">
